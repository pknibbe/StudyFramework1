...
{
    internal class RemoteDBContent : DataProvider
    {
        public override void AddQAG(string subjectName, string topicName, string subTopicName, string question, string answere)
        {
